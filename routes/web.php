...
//    $event = \App\Models\Event::find($event);  //select * from where id = 1
...
//    $eventData = [
//        'title' => 'Evento Atribuição em Massa',
//        'description' => 'Conteudo do evento atualizado com atualização em massa',
//        'body' => 'Conteudo Atualizado mass update',
//        'slug' => 'evento-atribuicao-em-massa',
//        'start_event' => date('Y-m-d H:i:s')
//    ];
//
...
//    return $event;
    ...
    //$event = \App\Models\Event::findOrFail(32);
//    return $event->delete();

    //Delete Models via ids... [30,31,21]
    //return \App\Models\Event::destroy(29, 30, 31,);
...
//Setando 'name?' como não obrigatorio
